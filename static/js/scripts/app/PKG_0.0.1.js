define([
    ...
    let get ={
        ...
        date:function(dateK) {
            ...
            let thisMonth = thisMonth < 10 ? "0" + thisMonth : JSON.stringify(thisMonth);
            let thisDay = today < 10 ? "0" + today : JSON.stringify(today);
            let thisWeek = JSON.stringify(newDate.getDay()); // 获取当前星期X(0-6,0代表星期天)
            let thisHour = thisHour < 10 ? "0" + thisHour : JSON.stringify(thisHour);
            let thisMinutes = thisMinutes < 10 ? "0" + thisMinutes : JSON.stringify(thisMinutes);
            let thisSeconds = thisSeconds < 10 ? "0" + thisSeconds : JSON.stringify(thisSeconds);
            ...
            value.week = thisWeek;
            value.hour = thisHour;
            value.minute = thisMinutes;
            value.second = thisSeconds;
            return (value);
